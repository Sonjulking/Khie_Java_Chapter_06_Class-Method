...
//		sc.nextLine(); // 아니면 아예 String 으로 입력받고 밑에서 Integer.parseInt() 이용해주는 거도 방법임.
//
...
//		String addr = sc.nextLine();
		...
		Student student = new Student(Integer.parseInt(sc.nextLine()), sc.nextLine(), sc.nextLine(), sc.nextLine(),
				sc.nextLine());

		student.getStduentInfo();
